...
; Drives
M569 P0 S1                                                                          ; physical drive 0 (Y) goes backwards using TMC2209 driver timings, stealthChop
M569 P1 S0                                                                          ; physical drive 1 (X) goes forwards using TMC2209 driver timings,  stealthChop
M569 P2 S0                                                                          ; physical drive 2 (Z) goes backwards using TMC2209 driver timings, stealthChop
...
M92 X80.00 Y80.00 Z1600.00 E690.00                                                ; set steps per mm; Z is set for TR8x2 leadscrew, adjust accordingly
M566 X900.00 Y900.00 Z60.00 E300.00                                                 ; set maximum instantaneous speed changes (mm/min)
M203 X18000.00 Y18000.00 Z1200.00 E12000.00                                         ; set maximum speeds (mm/min)
M201 X5000.00 Y4000.00 Z200.00 E6000.00                                             ; set accelerations (mm/s^2)
...
; Endstops
M574 X1 S1 P"^xstop"                                                                ; configure NC endstop switch for low end on Y 
M574 Y1 S1 P"^ystop"                                                                ; configure sensorless endstop for high end on Y
...
; define mesh grid
M557 X{global.x_axis_min+15,global.x_axis_max+sensors.probes[0].offsets[0]-1} Y{global.y_axis_min+15,global.y_axis_max+sensors.probes[0].offsets[1]-1} P{global.mesh_points+2}
...
M143 H1 S330                                                                        ; set temperature limit for heater 1 to 280C
...
; Fans
; -- part cooling fan
M950 F0 C"!fan0" Q1000                                                              ; create fan 0 on pin fan0 and set its frequency, inverted PWM
...
M572 D0 S0.02                                                                       ; smidge of pressure advance
; M207 S2.4 F3600 T1800 Z0.05                            ; retract settings (Orbiter with NF Zone hotend)
M207 S1 F2400 T1200 Z0.0                                                            ; retract settings (Papilio Lite with Dragonfly BMS)
...
if global.inputshaping
    ; M593 P"mzv" F40 S0.1 L10                        ; enable inputshaping
else
